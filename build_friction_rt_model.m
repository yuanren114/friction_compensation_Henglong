...
inputs = {'residual','friction_hat','omega_used','alpha_used','Ts_runtime', ...
...
add_line(model_name, 'Ts_const/1', 'Error_Preprocess/5');
...
code = [ ...
"function [e_raw, e_slow, update_enable, freeze_active] = fcn(residual, friction_hat, omega, alpha, Ts_runtime, omega_min, alpha_max, e_clip, e_high, e_low, recover_needed, window_duration, min_valid_count)" newline ...
...
"persistent e_hold freeze_state recover_count win_elapsed sum_mag count_valid" newline ...
...
"win_elapsed = win_elapsed + max(Ts_runtime, 0.0);" newline ...
"if sample_ok" newline ...
"    sum_mag = sum_mag + e_used;" newline ...
"    count_valid = count_valid + 1;" newline ...
"end" newline ...
"if win_elapsed >= max(window_duration, max(Ts_runtime, 1e-6))" newline ...
